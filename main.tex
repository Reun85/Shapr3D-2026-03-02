...
\begin{frame}
	\centering
	\includegraphics[width=\linewidth]{images/intervallum_pipeline.png}
\end{frame}
...
\end{column}
\begin{column}{0.45\textwidth}
	\only<2>{\includegraphics[width=\linewidth]{images/opt/DNF.png}}
	\only<1>{\includegraphics[width=\linewidth]{images/opt/NO_DNF.png}}
\end{column}
\end{columns}
\end{frame}
