\documentclass[xcolor=dvipsnames,aspectratio=169,9pt,draft]{beamer}
...
\begin{tikzpicture}
  ...
  \only<1>{
      ...
      \node[opacity=0.3] (img2) at (1cm,-1cm) {\includegraphics[height=0.65\paperheight]{images/csikos_balazs_csg.png}};
      \node (img1) {\includegraphics[height=0.65\paperheight]{images/csikos_balazs_sdf.png}};
  }

  
  \only<2>{
      \node [opacity=0.3](img1) {\includegraphics[height=0.65\paperheight]{images/csikos_balazs_sdf.png}};
      \node (img2) at (1cm,-1cm) {\includegraphics[height=0.65\paperheight]{images/csikos_balazs_csg.png}};
...
\end{itemize}
A képek miért nem illeszkednek rendesen?
\end{column}

\begin{column}{0.45\textwidth}
\only<1>{
\centering
\includegraphics[width=0.6\linewidth]{images/csikos_balazs_csg.png}
\includegraphics[width=0.3\linewidth]{images/csikos_balazs_sdf.png}%
\includegraphics[width=0.3\linewidth]{images/csikos_balazs_csg_2.png}
}
\only<2>{

\centering
\includegraphics[width=0.6\linewidth]{images/csikos_balazs_sdf.png}
\includegraphics[width=0.3\linewidth]{images/csikos_balazs_csg.png}%
\includegraphics[width=0.3\linewidth]{images/csikos_balazs_csg_2.png}
}
\only<3>{
\centering

\includegraphics[width=0.6\linewidth]{images/csikos_balazs_csg_2.png}
\includegraphics[width=0.3\linewidth]{images/csikos_balazs_sdf.png}%
\includegraphics[width=0.3\linewidth]{images/csikos_balazs_csg.png}
}
\end{column}
...
\end{column}
\begin{column}{0.45\textwidth}
\includegraphics[width=\linewidth]{images/half-space.png}
\end{column}
\end{columns}
\end{frame}
