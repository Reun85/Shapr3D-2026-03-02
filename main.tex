...
\end{column}
\begin{column}{0.45\textwidth}
	\only<1>{\includegraphics[width=\linewidth]{images/opt/DNF.png}}
	\only<2>{\includegraphics[width=\linewidth]{images/opt/NO_DNF.png}}
\end{column}
\end{columns}
\end{frame}
...
\end{column}
\begin{column}{0.45\textwidth}
	\only<2>{\includegraphics[width=\linewidth]{images/opt/DNF_const_merge.png}}
	\only<1>{\includegraphics[width=\linewidth]{images/opt/DNF_spatial_coherence.png}}
\end{column}
\end{columns}
\end{frame}
\begin{frame}{Részfa elimináció}
	\begin{columns}[c]
		\begin{column}{0.45\textwidth}
			Megfigyelés:
			\begin{itemize}
				\item A részfák valahol összeérnek
				\item Például unióknál
			\end{itemize}
			Ötlet:
			\begin{itemize}
				\item Minimum művelet $\Leftrightarrow$ select	
			\end{itemize}
		\end{column}
		\begin{column}{0.45\textwidth}
			\includegraphics[width=\linewidth]{images/opt/better_ultra_shader.png}
		\end{column}
	\end{columns}
\end{frame}
	...
	Ide még jönnek a képek.
		...
		\begin{table}[htbp]
			...
			\begin{tabular}{|l|c|c|c|c|c|c|}
				\hline
				\textbf{Scene $\mu$s} & \textbf{Sima} & \textbf{DNF} & \textbf{Ultra Shader} & \textbf{Collected} & \textbf{Recollect} & \textbf{Merge} \\ \hline
			...
			\caption{Timing Data for Various Scenes}
...
\begin{frame}{Összefoglalás}
	\vfill
	\centering\Huge \emph{Köszönöm a figyelmet!}
\end{frame}
